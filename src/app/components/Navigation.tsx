...
> (({ className, children, ...props }, ref) => (
        <NavigationMenuPrimitive.Trigger
            ref={ref}
            className={cn(
                'group inline-flex h-10 w-max items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-medium transition-colors hover:bg-slate-100 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:bg-slate-800 dark:hover:bg-slate-700 dark:hover:text-slate-100',
                className
            )}
            {...props}
        >
...
export function MainNavigation() {
    return (
        <NavigationMenu className="container mx-auto py-4">
            <NavigationMenuList>
                <NavigationMenuItem>
                    <Link href="./" legacyBehavior passHref>
                        <NavigationMenuLink className="font-bold text-lg hover:text-blue-600 transition-colors">
                            Your Consulting
                        </NavigationMenuLink>
                    </Link>
                </NavigationMenuItem>
